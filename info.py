...
API_ID = int(environ['26484367'])
API_HASH = environ['7ea2f38a04ec3771d910c5b2fa9e235a']
BOT_TOKEN = environ['7049035428:AAF7V5VegRucsIBOCqQN9hA3QAOzyjc2jV4']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6389146980').split()]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://muhammedsali2h:RQn#jW*d8x6vQgH:@cluster0.kx0ax.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/peruchazhimovie')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+j14T3ro4aYRlNDRl')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'https://t.me/+j14T3ro4aYRlNDRl')).split()]
